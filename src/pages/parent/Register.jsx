  ...
  return (
    <div className="min-h-screen bg-[#F2FBFC] text-[#08233A] flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md bg-white border border-[#D7EEF1] p-8 rounded-3xl shadow-[0_16px_50px_rgba(8,35,58,0.08)] relative z-10">
        <Link to="/parent/login" className="inline-flex items-center gap-1.5 text-[#527080] hover:text-[#08233A] text-sm font-semibold mb-6 transition-colors">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="font-display font-black text-2xl text-[#08233A] mt-2">Create Parent Account</h1>
          <p className="text-[#527080] text-xs mt-1">Join to track your child's literacy milestones, phonics, and growth.</p>
        </div>

        <form onSubmit={submit} className="flex flex-col gap-3.5">
          <div>
            <label className="block text-xs font-bold text-[#08233A] uppercase tracking-wider mb-1.5">Full Name</label>
            <input
              value={name}
          ...
          <Button
            ...
            disabled={loading}
          >
            {loading ? 'Creating Account…' : 'Complete Parent Registration'}
          </Button>
        </form>
        ...
        <div className="text-center mt-6 pt-5 border-t border-[#D7EEF1]">
          <p className="text-xs text-[#527080]">
            ...
            <Link to="/parent/login" className="text-[#0899AA] hover:underline font-bold ml-1">
              Sign In
            </Link>
          </p>
        </div>
